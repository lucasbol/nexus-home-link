<template>
  <div
    v-if="!weather"
    class="inline-flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-muted/30 border border-border/50 rounded-lg"
  >
  ...
  <div
    v-else
    class="inline-flex items-center gap-1 px-2 py-1.5 sm:gap-2 sm:px-3 sm:py-2 bg-muted/30 border border-border/50 rounded-lg hover:bg-muted/40 transition-colors cursor-pointer"
  >
