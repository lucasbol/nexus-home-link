<template>
  <Card class="p-6 bg-gradient-to-br from-card/80 to-card/60 border-border/50 backdrop-blur-sm">
    <div v-if="isLoading || smartHomeLoading" class="space-y-6">
      <!-- Header Skeleton -->
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex items-center justify-between border-b border-border/20 pb-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <Badge
            variant="outline"
            class="text-xs px-3 py-1 bg-green-500/10 text-green-600 border-green-500/20"
          >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-muted/5 rounded-xl p-4 border border-border/20">
            ...
            <div class="space-y-3">
              <div
                class="flex items-center justify-between p-3 bg-yellow-500/5 rounded-lg border border-yellow-500/20"
              >
                <div class="flex items-center gap-2">
                ...
                <div class="text-right">
                  <div class="text-lg font-bold text-yellow-600">
                    {{ overallStats.solarProduction }}kW
                  </div>
              ...
              <div
                class="flex items-center justify-between p-3 bg-blue-500/5 rounded-lg border border-blue-500/20"
              >
                <div class="flex items-center gap-2">
              ...
              >
                ...
                <div class="text-right">
                  <div class="text-lg font-bold text-red-600">
                    {{ overallStats.totalPowerConsumption }}W
                  </div>
          ...
          <div class="bg-muted/5 rounded-xl p-4 border border-border/20">
            ...
            <div class="space-y-2">
              <div
                v-for="(room, index) in rooms.slice(0, 3)"
                :key="room.name"
                class="flex items-center justify-between p-2 bg-muted/10 rounded-lg"
              >
          ...
          <div class="bg-muted/5 rounded-xl p-4 border border-border/20">
            ...
            <div class="space-y-2">
              <div
                class="flex items-center justify-between p-2 bg-green-500/5 rounded-lg border border-green-500/20"
              >
                <div class="flex items-center gap-2">
              ...
              <div
                class="flex items-center justify-between p-2 bg-blue-500/5 rounded-lg border border-blue-500/20"
              >
                <div class="flex items-center gap-2">
              ...
              <div
                class="flex items-center justify-between p-2 bg-orange-500/5 rounded-lg border border-orange-500/20"
              >
                <div class="flex items-center gap-2">
        ...
        <div class="lg:col-span-2 space-y-4">
          ...
          <div class="bg-muted/5 rounded-xl p-4 border border-border/20">
            ...
            <div
              v-for="room in rooms.filter(r => r.name === selectedRoom)"
              :key="room.name"
              class="space-y-4"
            >
              <!-- Living Room -->
              <div v-if="room.name === 'Living Room'" class="space-y-4">
                <!-- Living Room Header -->
                <div
                  class="relative overflow-hidden rounded-xl bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-red-500/10 border border-amber-500/20 p-6"
                >
                  <div
                    class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-amber-500/5 to-transparent rounded-full -translate-y-16 translate-x-16"
                  ></div>
                  <div class="relative">
                    <div class="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 class="text-lg font-semibold text-amber-900 dark:text-amber-100">
                          Living Room
                        </h5>
                        <p class="text-sm text-amber-700 dark:text-amber-300">
                          Cozy relaxation space • {{ room.temperature?.toFixed(1) }}°C •
                          {{ room.lightsOn }}/{{ room.totalLights }} lights on
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div
                    v-for="device in room.devices.filter(d => d.type === 'light')"
                    :key="device.id"
                    class="p-4 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 rounded-xl border border-amber-200/50 dark:border-amber-800/50"
                  >
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div
                    v-for="device in room.devices.filter(d => !d.controllable)"
                    :key="device.id"
                    class="p-3 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 rounded-lg border border-blue-200/50 dark:border-blue-800/50 text-center"
                  >
                    ...
                    <div
                      v-if="device.value"
                      class="text-lg font-bold text-blue-600 dark:text-blue-400 mt-1"
                    >
              ...
              <div v-else-if="room.name === 'Kitchen'" class="space-y-4">
                <!-- Kitchen Header -->
                <div
                  class="relative overflow-hidden rounded-xl bg-gradient-to-br from-red-500/10 via-orange-500/5 to-yellow-500/10 border border-red-500/20 p-6"
                >
                  <div
                    class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-red-500/5 to-transparent rounded-full -translate-y-16 translate-x-16"
                  ></div>
                  <div class="relative">
                    <div class="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 class="text-lg font-semibold text-red-900 dark:text-red-100">
                          Kitchen
                        </h5>
                        <p class="text-sm text-red-700 dark:text-red-300">
                          Cooking & dining hub • {{ room.temperature?.toFixed(1) }}°C •
                          {{ room.lightsOn }}/{{ room.totalLights }} lights on
                        </p>
                      </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div
                    v-for="device in room.devices.filter(d => d.controllable)"
                    :key="device.id"
                    class="p-4 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20 rounded-xl border border-red-200/50 dark:border-red-800/50"
                  >
                    <div class="flex items-center justify-between mb-3">
                      <div class="flex items-center gap-3">
                        <div
                    ...
                    <div
                      v-if="device.type === 'light' && device.brightness !== undefined"
                      class="space-y-2"
                    >
                      <div class="flex items-center justify-between text-sm">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div
                    v-for="device in room.devices.filter(d => !d.controllable)"
                    :key="device.id"
                    class="p-3 bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-950/20 dark:to-yellow-950/20 rounded-lg border border-orange-200/50 dark:border-orange-800/50 text-center"
                  >
                    <div :class="[getStatusColor(device.status), 'mb-2']">
                      <component :is="getDeviceIcon(device.type)" class="w-4 h-4 mx-auto" />
                    </div>
                    ...
                    <div
                      v-if="device.value"
                      class="text-lg font-bold text-orange-600 dark:text-orange-400 mt-1"
                    >
                      {{ device.value }}{{ device.unit }}
                    </div>
                  </div>
              ...
              <div v-else-if="room.name === 'Bedroom'" class="space-y-4">
                <!-- Bedroom Header -->
                <div
                  class="relative overflow-hidden rounded-xl bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-blue-500/10 border border-purple-500/20 p-6"
                >
                  <div
                    class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-500/5 to-transparent rounded-full -translate-y-16 translate-x-16"
                  ></div>
                  <div class="relative">
                    <div class="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 class="text-lg font-semibold text-purple-900 dark:text-purple-100">
                          Bedroom
                        </h5>
                        <p class="text-sm text-purple-700 dark:text-purple-300">
                          Rest & relaxation • {{ room.temperature?.toFixed(1) }}°C •
                          {{ room.lightsOn }}/{{ room.totalLights }} lights on
                        </p>
                      </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div
                    v-for="device in room.devices.filter(d => d.type === 'light')"
                    :key="device.id"
                    class="p-4 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 rounded-xl border border-purple-200/50 dark:border-purple-800/50"
                  >
                    <div class="flex items-center justify-between mb-3">
                      <div class="flex items-center gap-3">
                        <div
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div
                    v-for="device in room.devices.filter(d => !d.controllable)"
                    :key="device.id"
                    class="p-3 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-lg border border-blue-200/50 dark:border-blue-800/50 text-center"
                  >
                    <div :class="[getStatusColor(device.status), 'mb-2']">
                      <component :is="getDeviceIcon(device.type)" class="w-4 h-4 mx-auto" />
                    </div>
              ...
              <div v-else-if="room.name === 'Energy & Security'" class="space-y-4">
                ...
                <div
                  class="relative overflow-hidden rounded-xl bg-gradient-to-br from-green-500/10 via-emerald-500/5 to-teal-500/10 border border-green-500/20 p-6"
                >
                  <div
                    class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-500/5 to-transparent rounded-full -translate-y-16 translate-x-16"
                  ></div>
                  <div class="relative">
                    <div class="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 class="text-lg font-semibold text-green-900 dark:text-green-100">
                          Energy & Security
                        </h5>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div
                    v-for="device in room.devices.filter(d =>
                      ['solar', 'battery', 'gas'].includes(d.type)
                    )"
                    :key="device.id"
                    class="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 rounded-xl border border-green-200/50 dark:border-green-800/50"
                  >
                    <div class="flex items-center gap-3 mb-2">
                      <div
                        :class="[
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div
                    v-for="device in room.devices.filter(d =>
                      ['doorbell', 'motion', 'camera'].includes(d.type)
                    )"
                    :key="device.id"
                    class="p-3 bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/20 dark:to-cyan-950/20 rounded-lg border border-teal-200/50 dark:border-teal-800/50 text-center"
                  >
                    <div :class="[getStatusColor(device.status), 'mb-2']">
                      <component :is="getDeviceIcon(device.type)" class="w-4 h-4 mx-auto" />
                    </div>
                    <div class="text-sm font-medium text-teal-900 dark:text-teal-100">
                      {{ device.name }}
                    </div>
                    <div
                      :class="[
...
// Use the smart home composable
const {
  devices,
  loading: smartHomeLoading,
...
const toggleDevice = async (deviceId: string) => {
  try {
    await toggleDeviceAPI(deviceId)
    // Update local state
...
onMounted(async () => {
  ...
  setTimeout(() => {
    ...
    const avgTemp =
      mockRooms.reduce((sum, room) => sum + (room.temperature || 0), 0) / mockRooms.length
    const avgHumidity =
      mockRooms.reduce((sum, room) => sum + (room.humidity || 0), 0) / mockRooms.length
    const powerDevices = allDevices.filter(
      device => device.type === 'plug' && device.status === 'on'
    )
